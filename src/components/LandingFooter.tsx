  ...
  return (
    <>
      <RootHeader theme={theme}>
        <RootHeader.Features>
          <div className='flex gap-9 dark:text-white'>
      ...
      <main className='flex min-h-screen flex-col items-center justify-between gap-16 p-4 dark:bg-black dark:text-white xl:gap-24 xl:p-[40px]'>
        ...
        <h1 className='mt-10 text-center text-[40px] font-bold sm:text-[70px] xl:text-[76px] xl:leading-[100px]'>
          ...
          <div className='relative inline-block pr-2 font-montserrat text-[42px] font-bold text-indigo-600 sm:text-[70px] xl:text-[90px] xl:leading-[65px]'>
            <span className='absolute inline after:inline-block after:h-10 after:w-1 after:animate-[blink_1s_ease-in-out_infinite] dark:after:bg-white sm:after:h-16'>
              {currentText}
            </span>
      ...
      <footer
        className={
          'flex flex-col items-center justify-center overflow-hidden px-6 dark:bg-black dark:text-custom-black-100 sm:flex-row xl:px-10'
        }
      >
        <div className='mt-16 flex h-auto w-full flex-col items-center sm:mt-28 sm:h-[100px] sm:max-w-screen-xl sm:flex-row sm:justify-between'>
          ...
          <div className='flex h-auto items-center sm:gap-4'>
            <Link href='' className='p-2 hover:text-custom-violet'>
              Privacy Policy
            </Link>
            <Link href='' className='p-2 hover:text-custom-violet'>
              FAQ
          ...
          <div
            className={'mb-20 mt-12 flex items-center gap-4 sm:mb-0 sm:mt-0'}
          >
            <Link
            ...
            >
              <IconMail
                className='hover:fill-custom-violet'
